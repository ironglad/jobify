                ...
                <div className="flex flex-col-reverse md:flex-row items-center gap-12">
                    <div className="md:w-6/12">
                        ...
                        <p className="mt-4 text-lg leading-relaxed">
                            Welcome to <span className="text-indigo-600 font-semibold">Jobify</span>, your go-to platform for finding your dream job or hiring top talent. 
                        ...
                        <p className="mt-4 text-lg leading-relaxed">
                            At <span className="text-indigo-600 font-semibold">Jobify</span>, our mission is to <span className="font-semibold">empower careers</span> and <span className="font-semibold">streamline recruitment</span>. 
                        ...
                        <h2 className="mt-6 text-2xl font-bold text-gray-900">Why Choose Jobify?</h2>
                        ...
                        <p className="mt-4 text-lg leading-relaxed">
                            ...
                            <span className="text-indigo-600 font-semibold"> Sign up today</span> and let <span className="font-semibold">Jobify</span> help you achieve your goals!
                        </p>
                    </div>
